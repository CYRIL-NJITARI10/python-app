...
def hello_world():
    ...
    <form action="/textbox" method="get">
        <input type="submit" value="textbox">
    </form>
    '''
    button_google = '''
    ...
    '''
    button_google_analystics = '''
    <form action="/make_ganalytics_request" method="get">
        <input type="submit" value="Fetch Google analystics Cookies">
    </form>
    '''
    button_visitors = '''
    ...
    '''
    return prefix_google + message + "<br>" + button_textbox +button_google + button_google_analystics + button_visitors
